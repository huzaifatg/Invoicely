...
const CreateWithAIModal = ({ isOpen, onClose }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // navigate to the create invoice page with the parsed data
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
          ...
          <div className="space-y-4">
            <p className="text-sm text-slate-600">
              ...
              items, quantities, and prices), and our AI will attempt to create
              a structured invoice from it.
            </p>
            <TextareaField
              name="invoiceText"
              ...
              placeholder="E.g. Invoice for LexCorp: 2 widgets at $120 each, due in 30 days"
              rows={8}
            />
          </div>
